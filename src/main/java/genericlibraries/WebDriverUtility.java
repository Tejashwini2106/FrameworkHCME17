...
/**
 * This class contains all re-usable methods of  WebDriver
 * @author Teju
 *
 */
 ...
 */
public void handleChildBroeser()
{
  ...
  public void scollToElement(WebElement element)
{
  ...
  /**
   * this method is used to fetch the sceenshot based on base^4 formate
   */
...
driver.close();
 ...
 /**
  * this method is used to close all the window and exit freom browser
  */
 public void quitBrowser()
 {
	 driver.quit();
 }
public void explicitWait(long time, String itemAddedMessage) {
